This repository contains Damn Vulnerable DeFi (Decentralized Finance) CTFs (Capture the Flags) solutions built with the OpenZeppelin test libraries and the Truffle framework for contract compilation.
